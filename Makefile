...
# Generated by qmake (1.07a) (Qt 3.3.8b) on: Wed Aug 20 09:50:45 2025
# Project:  Orb.pro
# Template: app
...
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I/home/matthias/dev/qt/qt-x11-free-3.3.8b/mkspecs/default -I. -Isnappea/headers -I$(QTDIR)/include -Igui/moc/
LINK     = g++
LFLAGS   =  -Wl,-rpath,$(QTDIR)/lib
LIBS     = $(SUBLIBS) -L$(QTDIR)/lib -L/usr/X11R6/lib -L./snappea/code -lorb -lqt -lXext -lX11 -lm
AR       = ar cqs
RANLIB   = 
MOC      = $(QTDIR)/bin/moc
UIC      = $(QTDIR)/bin/uic
...
Makefile: Orb.pro  /home/matthias/dev/qt/qt-x11-free-3.3.8b/mkspecs/default/qmake.conf ../../qt/qt-x11-free-3.3.8b/lib/libqt.prl
